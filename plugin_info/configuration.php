...
<form class="form-horizontal">
	...
	<div class="form-group">
            ...
            <div class="col-lg-4">
			     <a class="btn btn-default" target="_blank" href="/plugins/badger/arduino/BadgerENC28J60/BadgerENC28J60.ino"><i class="fa fa-cloud-download"></i> {{Sketch pour Arduino + ENC28J60}}</a>
				 <a class="btn btn-default" target="_blank" href="/plugins/badger/arduino/BadgerW5100/BadgerW5100.ino"><i class="fa fa-cloud-download"></i> {{Sketch pour Arduino + W5100}}</a>
				 <a class="btn btn-default" target="_blank" href="/plugins/badger/arduino/JeedouinoLAN/JeedouinoLAN.ino"><i class="fa fa-cloud-download"></i> {{Sketch Jeedouino modifié}}</a>
				</div>  
	</div>
	<div class="form-group">
